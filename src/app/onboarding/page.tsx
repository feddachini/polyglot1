      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700 flex items-center justify-center p-4">
        <div className="max-w-md w-full">
          <div className="text-center text-white mb-12">
            ...
            <p className="text-lg opacity-75">With blockchain-powered learning</p>
          </div>
          ...
          <div className="space-y-6 mb-8">
            <div className="flex items-center gap-4 text-white">
              ...
              <div>
                ...
                <p className="text-sm opacity-80">Learn efficiently with proven SRS methods</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 text-white">
              ...
              <div>
                ...
                <p className="text-sm opacity-80">Connect romance languages for faster progress</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 text-white">
              ...
              <div>
                ...
                <p className="text-sm opacity-80">Get rewards and NFT certificates on Flow</p>
              </div>
            </div>
          </div>
            ...
            {!walletConnected ? (
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-blue-600 text-white py-4 rounded-xl font-semibold text-lg flex items-center justify-center gap-2 hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isConnecting ? (
                    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-600 to-pink-600 p-4">
        <div className="max-w-md mx-auto pt-8">
          <div className="text-center text-white mb-8">
            ...
            <p className="text-lg opacity-90 mb-1">Select 1-3 romance languages to learn</p>
            <p className="text-sm opacity-75">English will be your base language</p>
          </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-600 to-teal-600 p-4">
        <div className="max-w-md mx-auto pt-8">
          <div className="text-center text-white mb-8">
            ...
            <p className="text-lg opacity-90 mb-1">Start with essential decks, add more later</p>
            <p className="text-sm opacity-75">
              Learning {selectedLanguages.map(code => 
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 mb-1">{deck.description}</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-500 to-green-600 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl p-8 shadow-2xl text-center">
          ...
          <p className="text-gray-600 mb-6">Ready to start your multilingual journey</p>
          
          <div className="space-y-4 mb-8">
            <div className="bg-gray-50 rounded-xl p-4">
              <h3 className="font-semibold text-gray-800 mb-2">Learning Languages:</h3>
              <div className="flex gap-2 justify-center">
                {selectedLanguages.map(code => {
                  const lang = languages.find(l => l.code === code);
                  return (
                    <span key={code} className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm">
                      {lang?.flag} {lang?.name}
                    </span>
                  );
                })}
            ...
            <div className="bg-gray-50 rounded-xl p-4">
              <h3 className="font-semibold text-gray-800 mb-2">Starting Decks:</h3>
              <p className="text-sm text-gray-600">
                {selectedDecks.length} decks • {selectedDecks.reduce((total, deckId) => {
